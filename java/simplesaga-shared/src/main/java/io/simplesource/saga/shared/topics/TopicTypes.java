...
public class TopicTypes {
    ...
    public static class CommandTopic {
        ...
        public static List<String> all = Lists.of(request, response);
    }
    ...
    public static class SagaTopic {
        ...
        public static List<String> all = Lists.of(request, response, responseTopicMap, state, stateTransition);
        public static List<String> client = Lists.of(request, response);
    }
}
