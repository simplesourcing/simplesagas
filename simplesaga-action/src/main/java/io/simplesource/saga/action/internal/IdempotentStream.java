...
final class IdempotentStream {
    ...
    static <A> IdempotentAction<A> getActionRequestsWithResponse
        ...
        KTable<CommandId, ActionResponse<A>> actionByCommandId =
                actionResponse
        ...
        KStream<SagaId, Tuple2<ActionRequest<A>, ActionResponse<A>>> actionRequestWithResponse = actionRequests
        ...
        KStream<SagaId, Tuple2<ActionRequest<A>, ActionResponse<A>>>[] branches = actionRequestWithResponse
        ...
        KStream<SagaId, ActionResponse<A>> processedResponses = branches[0].mapValues((k, v) -> v.v2()).filter((k, v) -> false);
