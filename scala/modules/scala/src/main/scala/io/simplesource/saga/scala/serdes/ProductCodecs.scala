...
object ProductCodecs {
  ...
  def mappedCodec[A, B](b2p: B => A, p2b: A => B)(
      implicit aEnc: Encoder[A],
      aDec: Decoder[A]): (Encoder[B], Decoder[B]) =
    (aEnc.contramap(b2p), aDec.map(p2b))

  def productCodecs2[A0: Encoder: Decoder, A1: Encoder: Decoder, B](n0: String,
                                                                    n1: String)(
      b2p: B => (A0, A1),
  ...
  def productCodecs3[A0: Encoder: Decoder,
                     A1: Encoder: Decoder,
                     A2: Encoder: Decoder,
  ...
  def productCodecs4[A0: Encoder: Decoder,
    ...
    implicit val decoder: Decoder[B] =
      Decoder.forProduct4(n0, n1, n2, n3)((a0: A0, a1: A1, a2: A2, a3: A3) =>
        p2b(a0, a1, a2, a3))
  ...
  def productCodecs5[A0: Encoder: Decoder,
    ...
    implicit val decoder: Decoder[B] =
      Decoder.forProduct5(n0, n1, n2, n3, n4)(
        (a0: A0, a1: A1, a2: A2, a3: A3, a4: A4) => p2b(a0, a1, a2, a3, a4))
